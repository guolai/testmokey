...
- initWithValue:(void *)value type:(const char*)type
{
    ...
    name = [[NSString alloc] initWithCString:nameBeg
                                    encoding:NSASCIIStringEncoding];
...
{
    const char *type = [structType encoding:NSASCIIStringEncoding];
    int offset=0;
    int align;
    int rem;
    int i = 0;
...
- (const char *)type
{
    return [structType cStringUsingEncoding:NSASCIIStringEncoding];
}
...
{
    const char *type = [structType cStringUsingEncoding:NSASCIIStringEncoding];
